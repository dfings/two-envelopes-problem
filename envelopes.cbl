...
DATA DIVISION.
   ...
   *> Variables
   01 WS-CUTOFF PIC 9(3) VALUE 0.
   01 WS-TOTAL COMP-2 VALUE 0.
   01 WS-TRIAL-NUM PIC 9(5) VALUE 0.
   01 WS-EXPECTED-VALUE COMP-2 VALUE 0.
   01 WS-LOWER-VALUE COMP-2 VALUE 0.
   01 WS-HIGHER-VALUE COMP-2 VALUE 0.
   01 WS-VALUE COMP-2 VALUE 0.
   *> RNG support
   01 WS-RNG COMP-2 VALUE 0.
